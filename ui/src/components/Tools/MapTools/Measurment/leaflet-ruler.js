  ...
  L.Control.Ruler = L.Control.extend({
    ...
    _toggleMeasure: function () {
      ...
      if (this._choice) {
        ...
        this._clickCount = 0;
        this._tempLine = L.featureGroup().addTo(
          this._allLayers
        );
        this._tempPoint = L.featureGroup().addTo(
          this._allLayers
        );
        this._pointLayer = L.featureGroup().addTo(
          this._allLayers
        );
        this._polylineLayer = L.featureGroup().addTo(
          this._allLayers
        );
    ...
    _clicked: function (e) {
      ...
      if (
        ...
        if (this._movingLatLong) {
          L.polyline(
            [
              this._clickedPoints[this._clickCount - 1],
              this._movingLatLong,
            ],
    ...
    _moving: function (e) {
      if (this._clickedLatLong) {
        ...
        this._addedLength =
          this._result.Distance + this._totalLength;
        L.polyline(
